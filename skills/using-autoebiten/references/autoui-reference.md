...
> Purpose: XML format, ae tags, XPath queries, and API details
> Audience: Game developers integrating autoui, test writers using advanced queries
...
**For command reference and examples, see** [autoui-commands.md](./autoui-commands.md)
...
**Output:**
```xml
<Button _addr="<ADDR>" disabled="false" height="40" id="submit-btn" level="42" player_id="p001" player_name="Alice" role="primary" state="unchecked" visible="true" width="200" x="100" y="50"></Button><Button _addr="<ADDR>" disabled="false" height="40" id="cancel-btn" role="secondary" state="unchecked" visible="true" width="200" x="100" y="200"></Button>
```

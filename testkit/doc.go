...
//         game.HoldKey(input.KeyRight, 10)
//
//         // Verify player moved
//         x, err := game.StateQuery("Player.X")
...
//
//         // Inject key press
//         mock.InjectKeyPress(input.KeyRight)
//
//         // Advance 10 ticks
//         mock.Ticks(10)
//
...
// State Export:
//
// Games can export internal state using StateExporter, which enables reflection-based
// state queries via dot-notation paths like "Player.X" or "Inventory.0.Name":
//
